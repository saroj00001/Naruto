...
PICS = (environ.get('PICS', 'https://graph.org/file/890435ec5ff44ad8e371e-9bae3fca84a416c6da.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7364818327 2127658237').split()]
